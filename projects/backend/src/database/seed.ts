...
export const songReadiness1: ISongDBResult = {
	song_id: "aaaaaaaa-0eb2-40d2-b098-8bd9a09a4492",
	title: "Uday",
	suffix: null,
	year: 2018,
	bpm: null,
...
export const songReadiness2: ISongDBResult = {
	song_id: "aaaaaaaa-35fa-4490-9d43-5b1a178902d8",
	title: "Pulkit",
	suffix: null,
	year: 2018,
	bpm: null,
...
export const songReadiness3: ISongDBResult = {
	song_id: "aaaaaaaa-000e-49b2-86c6-6ff23060238b",
	title: "Zeel",
	suffix: null,
	year: 2019,
	bpm: 125,
...
export const songGovernance1: ISongDBResult = {
	song_id: "aaaaaaaa-055c-4768-b834-67aaa03cc3d1",
	title: "Sagar",
	suffix: null,
	year: 2019,
	bpm: 128,
...
export const songGovernance2: ISongDBResult = {
	song_id: "aaaaaaaa-71c9-43b0-8fb5-4a8a4b112a69",
	title: "Vivek",
	suffix: null,
	year: 2016,
	bpm: 109,
...
export const testData: ITestDataSchema = {
	...
	songs: {
		song1_library_user1: songReadiness1,
		song2_library_user1: songReadiness2,
		song3_library_user1: songReadiness3,
		song4_library_user2: songGovernance1,
		song5_library_user3: songGovernance2,
	},
	playlists: {
		playlist1_library_user1: {
			...
			date_removed: null,
			songs: [songReadiness1, songReadiness2, songReadiness3],
			date_added: moment().subtract(3, "hours").toDate(),
			share_id: libraryUser1ShareID,
		},
		playlist2_library_user1: {
			...
			date_removed: null,
			songs: [songGovernance1, songGovernance2],
			date_added: moment().subtract(3, "hours").toDate(),
			share_id: libraryUser1ShareID,
		},
		playlist_some_shared_library: {
			playlist_id: playlistSomeSharedLibraryID,
			name: "Some Common OnCalls 1",
			date_removed: null,
			songs: [songGovernance1, songReadiness2, songReadiness3],
			date_added: moment().subtract(3, "hours").toDate(),
			share_id: someShareShareID,
		},
		playlist_library_user2: {
			playlist_id: playlist1LibraryUser2ID,
			name: "Collection of Workspace 2",
			date_removed: null,
			songs: [songReadiness3],
			date_added: moment().subtract(3, "hours").toDate(),
			share_id: libraryUser2ShareID,
		},
	},
